...
export const getCars = async (req, res) => {
    try {
        ...
        const filters = {};
        if (location)
            filters['locationId'] = String(location);
        if (type)
...
export const createCar = async (req, res) => {
    try {
        ...
        const { name, type, fuel, transmission, seating, mileage, pricePerDay, pricePerHour, imageKey, images, locationId } = req.body;
...
export const updateCar = async (req, res) => {
    try {
        ...
        const { name, type, fuel, transmission, seating, mileage, pricePerDay, pricePerHour, imageKey, images, availability, locationId } = req.body;
        const data = {};
        if (name !== undefined)
            data['name'] = name;
        if (type !== undefined)
        ...
        if (pricePerDay !== undefined)
            data['pricePerDay'] = Number(pricePerDay);
